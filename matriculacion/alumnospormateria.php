...
$pagina->agregarConsulta("select * from registro where activo= 1 and id_ciudad = $ciudadusu");
$pagina->ejecutar();
...
$ciudad = $obj2->get_ciudadselect($res['id_ciudad']);
 ...
 ?>
          <tr>
            ...
            <td><?php echo $datoss[0]['nombre']; ?></td>

            <td><?php echo $datoss[0]['apellido']; ?></td>
