...
<form name="form" action="docentes1.php" class="form-horizontal" method="post" enctype="multipart/form-data">
<h2>Ingrese Docentes</h2>
 ...
 <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="email" id="inputPassword" placeholder="C.I." >
                <div id="email"></div>
              </div>
 </div>
 <div class="form-group">
