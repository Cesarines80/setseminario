...
function valida_alm()
{
	...
	}else
	{
		...
		if (form.txt_direccion.value==0)
	{
			document.getElementById("div_dir").innerHTML="<font color='#ff0000'>Ingrese su Direccion</font>";
			form.txt_direccion.value="";
			form.txt_direccion.focus();
			return false;
	}else
	{
		document.getElementById("div_dir").innerHTML="";
		}	
