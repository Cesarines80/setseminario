                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                             ...
                             <div class="form-group">
                              <label for="inputPassword" class="col-sm-2 control-label">Fecha de Nacimiento</label>
                                  ...
                                  ?>
                                      ...
                                      <div class="col-sm-4">
                                      <select name="txt_dia" id="txt_dia" class="form-control" onChange="from(document.form.txt_dia.value,'provincia1','../provincia1.php')">
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input type="email" class="form-control" name="txt_ci" id="txt_direccion" placeholder="C.I."  onclick="from1(document.form.txt_ci.value,'div_ci','verifica.php')" onKeyPress="return acceptNum(event)"  value="<?php echo $ci; ?>" maxlength="8">
                                <div id="div_ci"></div>
                              </div>
                            </div>
