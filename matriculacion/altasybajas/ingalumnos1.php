...
include'../conexio.php';
//print_r($_POST); exit;
$ciudades = $_POST['ciudad2'];
$provinciass = $_POST['provincia1'];
...
(null,'$nombre','$apellido','$telefono','$celular','$imagen_final','$estadocivil','$email','$direccion','$fec_nac','$pais','$ciuda','$provincia','$ci','$region','$ciudades','$provinciass','$distrito','$iglesialm',now(),'1')";
