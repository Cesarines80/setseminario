...
echo $pagina->agregarConsulta("select * from alumnos where nombre LIKE '%".$buscar."%' and estado = 1 and ciudad=$d");
        ...
        <div class="col-md-9 ">
             <form id="buscador" name="buscador" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>"> 
              ...
              <div class="input-group">
                ...
                <input type="search" class="form-control"   placeholder="Buscar aqui.." id="buscar" name="buscar" autofocus >
