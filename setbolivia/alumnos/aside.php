<aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index.php" class="brand-link">
                    ...
                    <span class="brand-text font-weight-light">ALUMNO</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="../files/alumnos/<?php echo $alumno[0]['imagen']; ?>" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
                            <a href="index.php" class="d-block"><?php echo $alumno[0]['nombre']; ?> <?php echo $alumno[0]['apellido']; ?></a>
                        </div>
                    </div>
