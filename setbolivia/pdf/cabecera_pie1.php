 ...
 function FancyTable()
{
	...
	$this->Cell(30,5,'2017/03/25',1,0,'C',false);
	$this->Cell(60,5,$datos[$i][descripcion],1,0,'C',false);
	$this->Cell(20,5,$datos[$i][creditos],1,0,'C',false);
	$this->Cell(50,5,$row2['nombre'].' '.$row2['apellido'],1,0,'C',false);
	$this->Cell(20,5,$row['nota'],0,'C',false);
	...
	$this->Cell(20,5,$datos1[$i][creditos],1,0,'C',false);
	$this->Cell(50,5,$row2['nombre'].' '.$row2['apellido'],1,0,'C',false);
	$this->Cell(20,5,$row3['nota'],0,'C',false);
